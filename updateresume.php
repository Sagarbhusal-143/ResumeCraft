    ...
    <div class="container">
        ...
        <div class="bg-white rounded shadow p-2 mt-4" style="min-height:80vh">
            <div class="d-flex justify-content-between border-bottom">
                <h5>Create Resume</h5>
                <div>
                <a href="myresumes.php" class="text-decoration-none"></history><i class="bi bi-arrow-left-circle"></i> Back</a>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="col-md-6">
                        ...
                        <input type="text" name="resume_title" placeholder="Web Designer" value="<?=@$resume['resume_title']?>" class="form-control" required>
                    </div>
                    <h5 class="mt-3 text-secondary"><i class="bi bi-person-badge"></i> Personal Information</h5>
                    <div class="col-md-6">
                        <label class="form-label">Full Name</label>
                        <input type="text" value="<?=@$resume['full_name']?>" name="full_name" placeholder="Sagar Bhusal" class="form-control" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Email</label>
                        <input type="email" value="<?=@$resume['email_id']?>" name="email_id" placeholder="Sagar@abc.com" class="form-control" required>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" min="1111111111" value="<?=@$resume['mobile_no']?>" name="mobile_no"  max="9999999999"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" value="<?=@$resume['languages']?>" placeholder="Nepali,English" name="languages" class="form-control">
                    </div>

                    <div class="col-12">
                        <label for="inputAddress" class="form-label"> Address</label>
                        <input type="text" value="<?=@$resume['address']?>" class="form-control"name="address" id="inputAddress" placeholder="Kritpur,Kathmandu" required>
                    </div>
                    <hr>
    ...
    ?>
     <div class="col-12 col-md-6 p-2">
                            <div class="p-2 border rounded">
                                ...
                                <p class="small text-secondary m-0" style="">
                                    If you have experience, you can have it
                                </p>
                        ...
                        ?>
                         <div class="col-12 col-md-6 p-2">
                                                <div class="p-2 border rounded">
                                                    ...
                                                    <p class="small text-secondary m-0" style="">
                                                        If you have education, you can have it
                                                    </p>
